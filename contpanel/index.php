...
include_once( 'includes/firewall.php' );
include_once( 'includes/myfunc.php' );
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">RaspAP Wifi Portal</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
          <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
              ...
              <li>
                <a href="index.php?page=firewall_conf"><i class="fa fa-fire fa-fw"></i> Firewall</a>
              </li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.navbar-default -->
